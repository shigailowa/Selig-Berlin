...
<html>
	...
	<form id = "zeitformular" action = "machereservierung.php">
		<div> Wählen Sie Datum und Uhrzeit: <input name = "tag" type="text" id="datepicker"> </div>
 		...
 		<div> <input name = "zeit" type = "time" id = "timepicker" min = "12:00" max = "22:00"> </div>
 		<div> <input type = "hidden" name = "tisch" id = "tischformular"></div>
